...
class WeeklyAdUpdates extends Mailable
{
...
//        if(!$user) $user = User::get('CMichaels');
        return $this->view('emails.weekly-ad-updates')
            ->from('no-reply@ionmedia.com','IONTV Admintool')
            ->subject($this->title)
            ->replyTo('no-reply@ionmedia.com','IONTV Admintool');
    }
}
