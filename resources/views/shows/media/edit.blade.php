                  ...
                  <div class="box-body">				 
					...
					<div class="form-group">
                                ...
                                <script type="text/template" id="qq-template-manual-trigger">
                                    <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Déposer le fichier ici">
                                        ...
                                        <div class="buttons">
                                            <div class="qq-upload-button-selector qq-upload-button  btn btn-primary">
                                                <div>Sélectionnez le fichier</div>
                                            </div>
                                        ...
                                        <span class="qq-drop-processing-selector qq-drop-processing">
                                            <span>Traitement de fichiers en cours ...</span>
                                        ...
                                        <ul class="qq-upload-list-selector qq-upload-list" aria-live="polite" aria-relevant="additions removals">
                                            <li>
                                                ...
                                                <button class="qq-btn qq-upload-cancel-selector qq-upload-cancel">Annuler</button>
                                                <button class="qq-btn qq-upload-retry-selector qq-upload-retry">Recommencer</button>
                                                <button class="qq-btn qq-upload-delete-selector qq-upload-delete">Effacer</button>
