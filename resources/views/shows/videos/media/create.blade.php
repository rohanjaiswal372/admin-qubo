					...
					<div class="form-group">
						  <div class="row">
						   <div class="form-group col-lg-3">
							  ...
							  {!! Form::select('show_id', ["Select One"] + $show_id_selector , $show_id , ['class' => 'form-control','onChange'=>";window.location='".URL::to("/shows/videos/media/create/?show_id=")."'+$('#show_id').val()",'autocomplete'=>"off"] ) !!}
							</div>	   
						  </div>
					</div>
					...
					<div class="form-group">
						  <div class="row">
						   <div class="form-group col-lg-3">
							  ...
							  {!! Form::select('upload_media_type', ["Select One"] + $media_type_selector , $media_type_selected , ['class' => 'form-control upload-param', 'onChange'=>"if(this.value == 1){ $('#episode_selectbox').hide(); }else{   $('#episode_selectbox').show();}",'autocomplete'=>"off"] ) !!}
							</div>	   
						  </div>
					</div>
					
					
				    <div id="episode_selectbox" style="{{ $media_type_selected == 2 ? "":"display:none;"  }}">
