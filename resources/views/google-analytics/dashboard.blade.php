...
@section("content")
  ...
  <div class="content-wrapper">
	...
	{!! HTML::style("css/google-analytics.css") !!}
				...
				<ul class="FlexGrid">
				  <li class="FlexGrid-item">
					<div class="Titles">
					  ...
					  <div class="Titles-sub">Metrics</div>
					</div>
				  </li>
...
@section('footer_js')
				...
				{!! HTML::script("js/chart-js/1.0.2/chart.js") !!}
				
				<!-- Include the Moment.js Library. -->
				{!! HTML::script("js/moment-js/2.10.2/moment.js") !!}
				
				<!-- Include the ViewSelector2 component script. -->
				{!! HTML::script("js/google-analytics/embed-api/components/view-selector2.js") !!}

				<!-- Include the DateRangeSelector component script. -->
				{!! HTML::script("js/google-analytics/embed-api/components/date-range-selector.js") !!}

				<!-- Include the ActiveUsers component script. -->
				{!! HTML::script("js/google-analytics/embed-api/components/active-users.js") !!}		

				<!-- Include the ActiveUsers component script. -->
				{!! HTML::script("js/google-analytics/embed-api/embed-api.js") !!}			
