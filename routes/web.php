...
Route::group(['middleware' => ['auth.ion', 'web', 'forceSSL']], function () {
    ...
    Route::get('shows/remove-images/{id}/{item_id}', 'ShowsController@getRemoveImages');
...
//
    ...
    Route::get('shows/{show_id}/episodes/{id}/edit', 'EpisodeController@edit');
    ...
    /* SCHEDULE  */
    Route::get('schedule/import/{debug?}', 'ScheduleController@importSchedule');
    Route::get('schedule/get/{date}', 'ScheduleController@getSchedule');
    ...
    /* CAMPAIGNS */
    Route::get('campaigns/export/{id}/{type}/{start_date?}/{end_date?}', 'CampaignsController@export');
    Route::get('campaigns/download-preview/{id}/', 'CampaignsController@downloadPreview');
    Route::get('campaigns/remove/{id}', 'CampaignsController@destroy');
    Route::get('campaigns/report/{id}', 'CampaignsController@getReport');
    Route::get('campaigns/detach_ad/{id}/{campaign_id}', 'CampaignsController@detach_ad');
    Route::get('campaigns/campaign-sponsor/{campaign_id}', 'CampaignsController@getCampaignSponsor');
    Route::get('campaigns/assets/{campaign_id}', 'CampaignsController@getAssets');
    Route::post('campaigns/assign-campaign-asset/', 'CampaignsController@getAssignCampaignAsset');
    Route::get('campaigns/delete/asset/{image_id}/{campaign_id}/{type}', 'CampaignsController@getDeleteCampaignAsset');
    Route::get('campaigns/download/asset/{image_id}/{campaign_id}', 'CampaignsController@getDownloadCampaignAsset');
    Route::get('campaigns/sponsor-logo/{sponsor_id}', 'CampaignsController@getSponsorLogo');
    Route::get('campaigns/expired/{action}', 'CampaignsController@getExpired');
    Route::get('campaigns/items/{type?}', 'CampaignsController@items');

    Route::resource('campaigns', 'CampaignsController');

    /* SPONSORS */
    Route::resource('sponsors', 'SponsorsController');
    Route::get('sponsors/add', 'SponsorsController@dynamicAdd');
    Route::get('sponsors/remove/{id}', 'SponsorsController@destroy');
    ...
    Route::resource('audience-relations' , 'FeedbacksController');
