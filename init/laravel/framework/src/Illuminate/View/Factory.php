...
class Factory implements FactoryContract
{
	...
	*/
	public function getEngineFromPath($path)
    {
			...
			$default_extensions = ["blade.php"=>"blade","php"=>"php"];
			
			foreach( array_keys($default_extensions) as $default_extension){
				if(!in_array($default_extension, $this->extensions)){
					$extension_not_found = true;
				}
			}
			
			$engine = ($extension_not_found) ? $default_extensions[trim($extension)] : $this->extensions[trim($extension)];
			*/
			$engine = $this->extensions[$extension];
    ...
    protected function getExtension($path)
    {
        ...
        return trim(Arr::first($extensions, function ($key, $value) use ($path) {
